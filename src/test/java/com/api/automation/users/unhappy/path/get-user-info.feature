@regression @users @unhappy-path @get-user-info @get
Feature: To test unhappy path for users/profile (get)
	...
	Scenario: Get User Info with no authorization
	...
	Scenario Outline: Get User Info with invalid authorization
		And path 'users/profile'
